...
# Load new Empire bus dataset
NEW_FILE = r"C:\Users\1000684\Downloads\BCS_fault_prediction\9M_Empire_AC_UK07PA6311_bcs.xlsx"
...
# Predict
print("\nEvaluating combined Empire model on UK07PA6311...")
y_pred = model.predict(X)

# Report accuracy
accuracy = accuracy_score(y, y_pred)
print(f"\n{'='*60}")
print(f"ACCURACY ON EMPIRE BUS (UK07PA6311): {accuracy:.4f} ({accuracy*100:.2f}%)")
print(f"{'='*60}")
