...
NEW_FILE = r"C:\Users\1000684\Downloads\BCS_fault_prediction\9M_MBMT_NAC_MH04LQ9367_bcs.xlsx"
...
# Predict
print("\nEvaluating MBMT model on MH04LQ9367...")
y_pred = model.predict(X)

# Report accuracy
accuracy = accuracy_score(y, y_pred)
print(f"\n{'='*60}")
print(f"ACCURACY ON MBMT BUS (MH04LQ9367): {accuracy:.4f} ({accuracy*100:.2f}%)")
print(f"{'='*60}")
